const cfFooterExample = `<script setup lang="ts">

import CfFooter from "@/components/controls/CfFooter.vue";
...
<template>
    <div class="flex gap-2 w-3/5">
      <cf-footer>
        <v-row justify="center" class="p-2">
          <cf-button
            v-for="link in links"
            :key="link.title"
            :label="link.title"
...
export default cfFooterExample;
