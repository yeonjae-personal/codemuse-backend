import { getPermissionListApi } from "@/api/admin/adminApi";
import { PermissionSearchParam } from "@/interfaces/admin/admin";
...
const usePermissionStore = defineStore("permission", {
  ...
  actions: {
    async fetchPermission(params?: Partial<PermissionSearchParam>) {
      try {
        const response = await getPermissionListApi(params);
