<template>
  <div class="h-full">
    <v-data-table-virtual
      ...
      item-value="name"
      class="custom-table no-horizontal-scroll !text-text-base !font-size-base h-full"
      density="default"
      :row-height="40"
      last-icon=""
      first-icon=""
    ...
    >
      <template #no-data>
        <div class="h-full justify-center items-center !font-size-base">
          <no-data />
        </div>
      </template>
      <template #item="{ item }">
    ...
    <div
      ...
      class="flex justify-end !mt-0 !mx-[24px] !mb-[8px] flex-wrap"
...
.no-horizontal-scroll:deep(.v-data-table-virtual__wrapper) {
  overflow-x: hidden;
}
</style>
