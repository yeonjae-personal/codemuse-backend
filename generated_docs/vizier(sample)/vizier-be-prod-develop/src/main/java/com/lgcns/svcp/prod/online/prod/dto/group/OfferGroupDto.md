...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/online/prod/dto/group/OfferGroupDto.java`  
> **생성일**: 2025-10-01  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`OfferGroupDto`](#class-offergroupdto) - 복잡도: 14
...
### <a id="class-offergroupdto"></a>🎯 `OfferGroupDto`
