...
### 🏗️ 클래스
- [`OfferStructureDetailReq`](#class-offerstructuredetailreq) - 복잡도: 4
...
### <a id="class-offerstructuredetailreq"></a>🎯 `OfferStructureDetailReq`
...
```java
public class OfferStructureDetailReq {
