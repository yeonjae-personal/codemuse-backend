...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/ui/prod/dto/dashboard/DsbdViewDto.java`  
> **생성일**: 2025-10-13  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`DsbdViewDto`](#class-dsbdviewdto) - 복잡도: 8
...
### <a id="class-dsbdviewdto"></a>🎯 `DsbdViewDto`
