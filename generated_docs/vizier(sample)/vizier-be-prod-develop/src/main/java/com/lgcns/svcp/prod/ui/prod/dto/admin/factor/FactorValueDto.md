...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/ui/prod/dto/admin/factor/FactorValueDto.java`  
> **생성일**: 2025-10-13  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`FactorValueDto`](#class-factorvaluedto) - 복잡도: 7
...
### <a id="class-factorvaluedto"></a>🎯 `FactorValueDto`
