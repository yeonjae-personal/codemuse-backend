...
### 🏗️ 클래스
- [`SearchTableDataReqDto`](#class-searchtabledatareqdto) - 복잡도: 4

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `java.util.List` • `java.util.Map` • `com.lgcns.svcp.prod.ui.prod.dto.common.search.DynamicFieldReq` • `com.lgcns.svcp.prod.util.paging.BasePaginationDto` • `lombok.Getter` • `lombok.Setter` | ⚡ **총 복잡도**: 4 |
| 📊 **총 토큰 수**: 44 |  |
...
### <a id="class-searchtabledatareqdto"></a>🎯 `SearchTableDataReqDto`
