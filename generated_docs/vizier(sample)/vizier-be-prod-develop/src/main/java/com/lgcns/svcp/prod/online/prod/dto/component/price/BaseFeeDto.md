...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/online/prod/dto/component/price/BaseFeeDto.java`  
> **생성일**: 2025-10-13  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`BaseFeeDto`](#class-basefeedto) - 복잡도: 14
...
### <a id="class-basefeedto"></a>🎯 `BaseFeeDto`
...
public class BaseFeeDto {
	private String bsfUuid;
	private String bsfCode;
	private String bsfName;
