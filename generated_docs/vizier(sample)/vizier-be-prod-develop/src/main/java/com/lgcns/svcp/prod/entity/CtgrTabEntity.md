...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/entity/CtgrTabEntity.java`  
> **생성일**: 2025-10-01  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`CtgrTabEntity`](#class-ctgrtabentity) - 복잡도: 6
...
### <a id="class-ctgrtabentity"></a>🎯 `CtgrTabEntity`
