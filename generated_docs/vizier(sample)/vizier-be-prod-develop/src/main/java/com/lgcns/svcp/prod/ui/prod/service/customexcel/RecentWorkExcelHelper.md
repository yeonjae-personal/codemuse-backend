...
### 🔌 인터페이스
- [`RecentWorkExcelHelper`](#interface-recentworkexcelhelper)
...
### <a id="interface-recentworkexcelhelper"></a>🔌 `RecentWorkExcelHelper`
...
```java
public interface RecentWorkExcelHelper extends ExcelHelper {
}...
```
