...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/ui/prod/dto/export/OfferExportDto.java`  
> **생성일**: 2025-10-01  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`OfferExportDto`](#class-offerexportdto) - 복잡도: 5
...
### <a id="class-offerexportdto"></a>🎯 `OfferExportDto`
