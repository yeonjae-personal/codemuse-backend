...
### 🏗️ 클래스
- [`SaveTableDataReqDto`](#class-savetabledatareqdto) - 복잡도: 5

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `java.util.List` • `lombok.Getter` • `lombok.Setter` | ⚡ **총 복잡도**: 5 |
| 📊 **총 토큰 수**: 38 |  |
...
### <a id="class-savetabledatareqdto"></a>🎯 `SaveTableDataReqDto`
