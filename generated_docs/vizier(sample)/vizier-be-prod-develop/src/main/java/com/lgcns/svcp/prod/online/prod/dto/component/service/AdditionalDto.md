...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/online/prod/dto/component/service/AdditionalDto.java`  
> **생성일**: 2025-10-13  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`AdditionalDto`](#class-additionaldto) - 복잡도: 14
