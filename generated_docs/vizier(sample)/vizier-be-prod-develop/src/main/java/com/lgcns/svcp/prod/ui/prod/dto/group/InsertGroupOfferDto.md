...
### 🏗️ 클래스
- [`InsertGroupOfferDto`](#class-insertgroupofferdto) - 복잡도: 6

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `com.lgcns.svcp.prod.ui.prod.dto.BaseDto` • `lombok.AllArgsConstructor` • `lombok.Getter` • `lombok.NoArgsConstructor` • `lombok.Setter` | ⚡ **총 복잡도**: 6 |
| 📊 **총 토큰 수**: 54 |  |
...
### <a id="class-insertgroupofferdto"></a>🎯 `InsertGroupOfferDto`
