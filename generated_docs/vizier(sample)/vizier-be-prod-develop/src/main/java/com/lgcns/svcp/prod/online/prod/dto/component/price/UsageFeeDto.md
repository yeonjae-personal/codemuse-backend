...
> **파일 경로**: `vizier(sample)/vizier-be-prod-develop/src/main/java/com/lgcns/svcp/prod/online/prod/dto/component/price/UsageFeeDto.java`  
> **생성일**: 2025-10-01  
> **Chunk 수**: 3개  
> **언어**: Java
---
...
### 🏗️ 클래스
- [`UsageFeeDto`](#class-usagefeedto) - 복잡도: 14
...
### <a id="class-usagefeedto"></a>🎯 `UsageFeeDto`
...
public class UsageFeeDto {
	private String usfUuid;
	private String usfCode;
