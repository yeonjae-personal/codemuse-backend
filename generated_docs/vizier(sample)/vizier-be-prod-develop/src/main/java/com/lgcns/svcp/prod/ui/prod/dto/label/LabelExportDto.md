...
### 🏗️ 클래스
- [`LabelExportDto`](#class-labelexportdto) - 복잡도: 7

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `com.lgcns.svcp.prod.util.excel.annotation.CustomTitleHeader` • `lombok.Getter` • `lombok.Setter` | ⚡ **총 복잡도**: 7 |
| 📊 **총 토큰 수**: 51 |  |
...
### <a id="class-labelexportdto"></a>🎯 `LabelExportDto`
