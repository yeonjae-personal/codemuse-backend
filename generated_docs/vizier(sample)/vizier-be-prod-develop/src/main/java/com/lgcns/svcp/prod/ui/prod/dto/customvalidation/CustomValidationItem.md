...
### 🏗️ 클래스
- [`CustomValidationItem`](#class-customvalidationitem) - 복잡도: 4

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `java.util.List` • `com.lgcns.svcp.prod.ui.prod.dto.item.Item` • `lombok.Getter` • `lombok.Setter` | ⚡ **총 복잡도**: 4 |
| 📊 **총 토큰 수**: 34 |  |
...
### <a id="class-customvalidationitem"></a>🎯 `CustomValidationItem`
