...
### 🏗️ 클래스
- [`OfferBySaleChannelDto`](#class-offerbysalechanneldto) - 복잡도: 6

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `com.lgcns.svcp.prod.util.paging.BasePaginationDto` • `lombok.Data` | ⚡ **총 복잡도**: 6 |
| 📊 **총 토큰 수**: 43 |  |
...
### <a id="class-offerbysalechanneldto"></a>🎯 `OfferBySaleChannelDto`
