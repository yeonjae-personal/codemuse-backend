...
### 🏗️ 클래스
- [`OfferCreateInfo`](#class-offercreateinfo) - 복잡도: 3

## 📋 파일 개요

| | |
|--|--|
| 📦 **의존성**: `java.util.List` • `com.lgcns.svcp.prod.ui.prod.dto.item.detail.ItemMappingDetailDto` • `com.lgcns.svcp.prod.ui.prod.dto.offer.structure.OfferStructureDetailRes` • `lombok.Getter` • `lombok.Setter` | ⚡ **총 복잡도**: 3 |
| 📊 **총 토큰 수**: 34 |  |
...
### <a id="class-offercreateinfo"></a>🎯 `OfferCreateInfo`
